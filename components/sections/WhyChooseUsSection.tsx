...
const features = [
  ...
  },
  {
    ...
    title: "24/7 Support",
    description: "Round-the-clock support throughout your journey. We're always just a phone call away whenever you need assistance."
  }
];

export default function WhyChooseUsSection() {
  return (
    <section id="why-us" className="section bg-[var(--bg-secondary)]">
      <div className="max-w-7xl mx-auto px-6">
        {/* Section Header */}
        <div className="text-center max-w-3xl mx-auto mb-16">
          <span className="caps">Why Choose Us</span>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            ...
            >
              <div className="w-14 h-14 rounded-xl bg-[var(--bg-secondary)] flex items-center justify-center text-[var(--accent)] mb-5 group-hover:bg-[var(--accent)] group-hover:text-white transition-colors duration-300">
                {feature.icon}
              </div>
